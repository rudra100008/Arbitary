        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-20">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-2 group">
              <span className="text-black font-black text-2xl tracking-tighter uppercase">
                ARBITRARY
              </span>
            </Link>
            <p className="text-zinc-500 max-w-xs leading-relaxed">
              Pushing the boundaries of digital creativity. We build high-end
            ...
            <div className="flex gap-4">
              {[
                {
                  name: "Instagram",
                  url: "https://www.instagram.com/arbitrary.group/",
                  icon: (
                    <svg
                ...
                {
                  name: "YouTube",
                  url: "https://www.youtube.com/@ChannelArbitrary",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                ...
                {
                  name: "Facebook",
                  url: "https://www.facebook.com/arbitrary.group/?ref=PROFILE_EDIT_xav_ig_profile_page_web",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                ...
                {
                  name: "TikTok",
                  url: "https://www.tiktok.com/@arbitrary_group?fbclid=PAZXh0bgNhZW0CMTEAc3J0YwZhcHBfaWQMMjU2MjgxMDQwNTU4AAGnVqxRLF_0T9QOgUV_AUD60nzhCw6quWMEZigQc2uoHO8UYhJkNx5_GhdMQjU_aem_kxIzQoiRjOP98rz08zqPMg",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      ...
                      strokeLinejoin="round"
                    >
                      <path d="M9 12a4 4 0 1 0 4 4V2h5" />
          ...
          {/* Quick Links */}
          <div className="space-y-6">
            <h4 className="text-[#FACC15] font-bold uppercase tracking-widest text-sm">
              Navigation
            </h4>
            <ul className="space-y-4">
              {["Home", "Work", "Events", "Records", "About", "Contact"].map(
                (item) => (
                  <li key={item}>
                    <Link
            ...
            <ul className="space-y-4 text-zinc-500">
              <li>
                <Link href="/contact" className="block group">
                  <p className="text-black font-bold uppercase text-xs tracking-widest mb-1 group-hover:text-[#FACC15] transition-colors">
                    Headquarters
                  </p>
