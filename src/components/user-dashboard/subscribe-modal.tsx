  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[52px] sm:pt-[56px] md:pt-[68px]">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md mx-3 sm:mx-4 mt-2 md:mt-4 max-h-[calc(100vh-64px)] sm:max-h-[calc(100vh-72px)] md:max-h-[calc(100vh-80px)] overflow-y-auto scrollbar-hide modal-in">
        <div className="bg-gradient-to-br from-red-500 via-red-600 to-red-700 px-4 pt-3 pb-5 sm:px-5 sm:pt-4 sm:pb-6 md:px-6 md:pt-5 md:pb-7 rounded-t-3xl">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-red-200">
              YouTube Subscribe
            </span>
            <button
              onClick={onClose}
          ...
          <p className="text-red-200 text-[11px] sm:text-xs md:text-sm mt-0.5 line-clamp-2">
            {task?.description || ""}
          </p>
        </div>
          ...
          {verified ? (
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-red-600 text-white text-xs sm:text-sm font-black flex items-center justify-center shrink-0 mt-0.5">
                  1
                </div>
                <div>
                  <p className="font-bold text-gray-800 text-xs sm:text-sm md:text-base">Open the YouTube channel</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-gray-800 text-xs sm:text-sm md:text-base">Subscribe & Verify</p>
                  <p className="text-gray-500 text-[11px] sm:text-xs mt-0.5">
